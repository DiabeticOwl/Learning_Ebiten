...
//go:generate go run github.com/hajimehoshi/file2byteslice/cmd/file2byteslice -input ./NG/objects/duck_outline_target_white.png -output ./PNG/objects/duck_outline_target_white.go -package objects -var DuckOutlineTargetWhite_png
